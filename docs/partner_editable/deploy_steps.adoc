...
This solution includes a CloudFormation template, viz. link:templates/NR-EC2InfraAgentSSMAutomation.template.yaml[NR-EC2InfraAgentSSMAutomation.template.yaml] that you deploy in your AWS account as StackSet. You should deploy the StackSet instances in your AWS accounts across all regions where you plan to have New Relic Infrastructure agent installed on your EC2 instances.
