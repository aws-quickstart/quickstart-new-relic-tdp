...
* Deploy {partner-product-short-name} into a single AWS Account (view template)
* link:#Deploy_using_Stack_Sets[Deploy {partner-product-short-name} using Stack Sets])
