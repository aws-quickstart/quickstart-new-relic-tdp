...
* Amazon Elastic Compute Cloud (Amazon EC2) instance profile and a linked IAM role if you choose to create a new instance profile when launching the template.
